...
{
    public class CarNotificationHandler1 : INotificationHandler<CarNotification>
    {
        public CarNotificationHandler1(ILogger<CarNotificationHandler1> logger)
        {
            _logger = logger;
        }

        private readonly ILogger<CarNotificationHandler1> _logger;
